...
// Location of scratch directory for data and log writing
static const std::string mainOutDir = "/scratch/mu2e/mu2eshift_stm_readout__gr3/STMDAQ/";
...
// Number of events per data struct
static const int ev_num = 8;

// The global data struct
template <typename T>
struct data_struct {
  int count = 0;
  int data_type = 0; // 0 = Raw, 1 = ZS, 2 = MWD
