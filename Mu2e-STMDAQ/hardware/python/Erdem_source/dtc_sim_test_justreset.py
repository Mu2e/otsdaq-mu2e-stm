...
hw.getNode("Buffers.dtc_sim_params.deltahb").write (0x30D4) #(0x30D4) #(0x240) # #(0x160) #(0x200) (0x920) #
hw.dispatch()
hw.getNode("Buffers.dtc_sim_params.numberhb").write(0xC414) #(0xffffe80)  #(0x1000) # #(0x120) #(0xf0) #(0xc0) #(0x60) #(0x30) 
hw.dispatch()
time.sleep(0.02)
