...
def FMC120_adc_init_tp(wibNode):
   ...
   s.spi_write(wibNode,ADC_SELECT_BOTH,0x6000,0x90) #set control K  - Erdem test mode enabled bit 4
   s.spi_write(wibNode,ADC_SELECT_BOTH,0x6002,0x60) #setting the test pattern
