...
print(hex(temp))
time.sleep(0.5)
temp=hw.getNode("CID_registers.ADC_type").read()
hw.dispatch()
print(hex(temp))
time.sleep(0.5)
temp=hw.getNode("CID_registers.ADC_channel_0_valid").read()
hw.dispatch()
print(temp)
time.sleep(0.5)
temp=hw.getNode("CID_registers.ADC_channel_1_valid").read()
hw.dispatch()
print(temp)
time.sleep(0.5)
...
#hw.getNode("Buffers.Readout_regs.10g_readout_chan1_chan2").write(0x1)
#hw.dispatch()
...
#hw.getNode("Buffers.dtc_sim_params.deltahb").write (0x30D4) #(0x240) # #(0x160) #(0x200) (0x920) #
#hw.dispatch()
#hw.getNode("Buffers.dtc_sim_params.numberhb").write(0x97FF) #(0xffffe80)  #(0x1000) # #(0x120) #(0xf0) #(0xc0) #(0x60) #(0x30) 
#hw.dispatch()
#time.sleep(0.02)
