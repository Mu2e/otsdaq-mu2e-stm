...
hw.getNode("Buffers.Readout_regs.ext_trig_timeout").write(0x1DE2) #(0x15F90) #(0x249F0) # timeout is 75 MHz clock, 200 us = 0x3A98
 #hw.getNode("Buffers.Readout_regs.ext_trig_timeout").write(0x249F0) #(0x15F90) #(0x249F0) # timeout is 75 MHz clock, 200 us = 0x3A98 
hw.dispatch()
...
hw.dispatch()
hw.getNode("Buffers.dtc_sim_params.numberhb").write(0xFFFFFF)#(0x6FFFFFFF)  #(0x1000) # #(0x120) #(0xf0) #(0xc0) #(0x60) #(0x30) 
hw.dispatch()
time.sleep(0.02)
