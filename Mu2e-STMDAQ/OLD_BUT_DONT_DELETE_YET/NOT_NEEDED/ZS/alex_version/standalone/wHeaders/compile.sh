...
echo "g++ $CCOPTS $WARNING dataVars.cc genData.cc zeroSuppress.cc testZSdaq.cc -o run.exe"
g++ $CCOPTS $WARNING dataVars.cc genData.cc zeroSuppress.cc testZSdaq.cc -o run.exe
