...
public:
  ...
  int zs_buffer_num[CHNUM] = {};
  int pull_buffer_num[CHNUM] = {};
  int push_buffer_num[CHNUM] = {};

  // bool buffer_free[CHNUM][buffer_num] = {{true,true,true},{true,true,true}};
  // std::array<std::array<bool,buffer_num>,CHNUM> test {{
  //   {true,true,true},
  //     {true,true,true}}};
  std::array<std::array<std::atomic<bool>,buffer_num>,CHNUM> buffer_free;

  uint64_t buffer_occupancy[CHNUM][buffer_num] = {{}};

  int16_t* raw_buffer[CHNUM][buffer_num];
  int16_t* zs_buffer[CHNUM][buffer_num];
