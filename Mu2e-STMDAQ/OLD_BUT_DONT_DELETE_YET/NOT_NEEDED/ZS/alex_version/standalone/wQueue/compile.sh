...
echo "g++ -std=c++11 -pthread $CCOPTS $WARNING dataVars.cc queue.cc genData.cc zeroSuppress.cc testZSdaq.cc -o run.exe"
g++ -std=c++11 -pthread $CCOPTS $WARNING dataVars.cc queue.cc genData.cc zeroSuppress.cc testZSdaq.cc -o run.exe
