#include "STMDAQ-TestBeam/ZS/ZS.h"
...
ZS::ZS(double   _hardwareclockSPILL,
       double   _hardwareclockGAP,
       double   _NRAMblocks,
       double   _ADCRAM,
...
void ZS::supalg(int16_t* allchunk)
{
	...
	realtrigger_vect =
	    new unsigned long int[nADC_chunk];  //no more triggers than adc values per chunk
