...
public:
  ...
  void set_config_params(double _hardwareclockSPILL, double _hardwareclockGAP,
  ...
  void get_config_params_xml(Xml* xml_file){
  ...
  // Form zero-supressed data array
  void ZS_array();
  ...
  // int16_t *bits_64_4x16(uint64_t input){

  //   //     int16_t bits_4x16[4] = {0};
  //   // // Chunk number                                                                                 
  //   // bits_4x16[0] = input & 0x0000FFFF;
  //   // bits_4x16[1] = input >> 16;
  //   // bits_4x16[2] = input >> 32;
  //   // bits_4x16[3] = input >> 48;
