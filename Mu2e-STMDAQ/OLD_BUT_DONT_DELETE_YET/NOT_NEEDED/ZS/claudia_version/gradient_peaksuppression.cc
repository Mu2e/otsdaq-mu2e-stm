...
int main(int narg, char* arg[]){
  ...
  #ifdef PRINT_COUT
  std::cout<<"fadc= "<<fADC<<"MHz, window: "<<window<<" threshold "<<threshold<<"tbefore: "<<tbefore<<"us tafter "<<tafter<<" us"<<std::endl;
  #endif
  ...
  for(unsigned long int i=0;i<(n-window);i++){
	...
	continue;}
      ...
      #ifdef PRINT_COUT
      std::cout<<"Trigger number: "<<triggercounter<<": "<<trigger<<" Triggertime: "<<trigger*tadc<<std::endl;
      #endif
