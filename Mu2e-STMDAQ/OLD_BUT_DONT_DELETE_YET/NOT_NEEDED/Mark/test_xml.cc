...
int main()
{
	...
	unsigned int fmc144_ext_slice_length =
	    xml_file->int_from_hex_value("stm.fmc144_ext_slice_length");
	std::cout << "fmc144_ext_slice_length [hex] = " << std::hex << fmc144_ext_slice_length
	          << " [int] = " << std::dec << fmc144_ext_slice_length << std::endl;
}
