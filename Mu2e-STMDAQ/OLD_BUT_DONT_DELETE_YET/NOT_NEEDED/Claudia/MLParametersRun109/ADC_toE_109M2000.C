...
void ADC_toE_109M2000() {
  ...
  //Abrimos el txt
  fstream readfile;
  //readfile.open("../../../DATA/Claudia/MLParametersRun109/M2000L2000/run_00109.txt",ios::in);
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile2;
  //readfile2.open("../../../DATA/Claudia/MLParametersRun109/M2000L1000/run_00109.txt",ios::in);
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile3;
  //readfile3.open("../../../DATA/Claudia/MLParametersRun109/M2000L500/run_00109.txt",ios::in);
  ...
  fstream readfile4;
  //readfile4.open("../../../DATA/Claudia/MLParametersRun109/M2000L100/run_00109.txt",ios::in);
...
//line661->Draw("same");
 auto leg1 = new TLegend(0.21,0.6,0.5,0.82);
  ...
  //c1->Print("M2000new_0.57kev.pdf","pdf");
  //c1->Print("M2000new_0.57kev.png","png");
  //c1->Print("M2000fitnew_0.57kev.pdf","pdf");                                                                           
  //c1->Print("M2000fitnew_0.57kev.png","png"); 
}
