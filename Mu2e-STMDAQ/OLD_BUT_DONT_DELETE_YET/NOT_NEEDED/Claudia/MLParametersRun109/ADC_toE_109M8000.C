...
void ADC_toE_109M8000() {
  ...
  double fitrange[2]={650, 670};

  //M8000L8000  
  TH1F*h1 = new TH1F("TH1","", bins, xx1[0], xx1[1]);//binning of 0.57 kev    
  //Abrimos el txt
  fstream readfile;
  //readfile.open("../../../DATA/Claudia/MLParametersRun109/M8000L8000/run_00109.txt",ios::in);
  readfile.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M8000L8000/run_00109.txt",ios::in);  
  string name;
  ...
  cout<<"Mean L=8000: "<<h1->GetMean()<<endl;
  cout<<"RMS L=8000: "<<h1->GetRMS()<<endl;
  cout<<"MeanError L=8000: "<<h1->GetMeanError()<<endl;
  cout<<"RMSError L=8000: "<<h1->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile2;
  //readfile2.open("../../../DATA/Claudia/MLParametersRun109/M8000L5000/run_00109.txt",ios::in);
  readfile2.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M8000L5000/run_00109.txt",ios::in);
  string name2;
  ...
  cout<<"Mean L=5000: "<<h2->GetMean()<<endl;
  cout<<"RMS L=5000: "<<h2->GetRMS()<<endl;
  cout<<"MeanError L=5000: "<<h2->GetMeanError()<<endl;
  cout<<"RMSError L=5000: "<<h2->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile3;
  //readfile3.open("../../../DATA/Claudia/MLParametersRun109/M8000L1000/run_00109.txt",ios::in);
  readfile3.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M8000L1000/run_00109.txt",ios::in);
  string name3;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile4;
  //readfile4.open("../../../DATA/Claudia/MLParametersRun109/M8000L500/run_00109.txt",ios::in);
  readfile4.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M8000L500/run_00109.txt",ios::in);
  string name4;
  ...
  Fitwide4->SetParameters(1.31429e+02,660,2.01827e+00 );
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile5;
  //readfile5.open("../../../DATA/Claudia/MLParametersRun109/M8000L100/run_00109.txt",ios::in);
  readfile5.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M8000L100/run_00109.txt",ios::in);
  string name5;
  ...
  Fitwide5->SetParameters(1.31429e+02,670,2.01827e+00 );
...
//line661->Draw("same");
 auto leg1 = new TLegend(0.21,0.5,0.44,0.82);
  ...
  leg1->AddEntry(h2, "L=5000","l");
  leg1->AddEntry(h1, "L=8000","l");
  leg1->Draw("same");



  //c1->Print("M8000_0.57kev.pdf","pdf");
  //c1->Print("M8000_0.57kev.png","png");
  //c1->Print("M8000fit_0.57kev.pdf","pdf");                                                                           
  //c1->Print("M8000fit_0.57kev.png","png"); 
}
