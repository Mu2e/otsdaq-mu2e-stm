...
void ADC_toE_109M200() {
  ...
  double fitrange[2]={630, 685};

  //M200L200  
  TH1F*h1 = new TH1F("TH1","", bins, xx1[0], xx1[1]);//binning of 0.57 kev    
  //Abrimos el txt
  fstream readfile;
  //readfile.open("../../../DATA/Claudia/MLParametersRun109/M200L200/run_00109.txt",ios::in);
  readfile.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M200L200/run_00109.txt",ios::in); 
  string name;
  ...
  cout<<"Mean L=200: "<<h1->GetMean()<<endl;
  cout<<"RMS L=200: "<<h1->GetRMS()<<endl;
  cout<<"MeanError L=200: "<<h1->GetMeanError()<<endl;
  cout<<"RMSError L=200: "<<h1->GetRMSError()<<endl;
  ...
  //Abrimos el txt                               
  fstream readfile2;
  //readfile2.open("../../../DATA/Claudia/MLParametersRun109/M200L100/run_00109.txt",ios::in);
  readfile2.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M200L100/run_00109.txt",ios::in);
  string name2;
  ...
  Fitwide2->SetParameters(1.31429e+02,670,2.01827e+00 );
  ...
  cout<<"Mean L=100: "<<h2->GetMean()<<endl;
  cout<<"RMS L=100: "<<h2->GetRMS()<<endl;
  cout<<"MeanError L=100: "<<h2->GetMeanError()<<endl;
  cout<<"RMSError L=100: "<<h2->GetRMSError()<<endl;
  ...
  //Abrimos el txt                     
  fstream readfile3;
  //readfile3.open("../../../DATA/Claudia/MLParametersRun109/M200L50/run_00109.txt",ios::in);
  readfile3.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M200L50/run_00109.txt",ios::in);
  string name3;
  ...
  Fitwide3->SetParameters(1.31429e+02,670,2.01827e+00 );
  ...
  cout<<"Mean L=50: "<<h3->GetMean()<<endl;
  cout<<"RMS L=50: "<<h3->GetRMS()<<endl;
  cout<<"MeanError L=50: "<<h3->GetMeanError()<<endl;
  cout<<"RMSError L=50: "<<h3->GetRMSError()<<endl;



  std::string str = "{}^{137}Cs, M=200";
...
//line661->Draw("same");
  ...
  leg1->AddEntry(h3, "L=50","l");
  leg1->AddEntry(h2, "L=100","l");
  leg1->AddEntry(h1, "L=200","l");
  leg1->Draw("same");



  //c1->Print("M200_0.57kev.pdf","pdf");
  //c1->Print("M200_0.57kev.png","png");
  //c1->Print("M200fit_0.57kev.pdf","pdf");                                                                           
  //c1->Print("M200fit_0.57keV.png","png"); 
}
