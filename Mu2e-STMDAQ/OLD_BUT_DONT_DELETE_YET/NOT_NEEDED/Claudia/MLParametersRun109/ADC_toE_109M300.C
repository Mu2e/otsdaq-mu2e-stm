...
//line661->Draw("same");
 auto leg1 = new TLegend(0.21,0.6,0.5,0.82);
  ...
  //c1->Print("M300new_0.57kev.pdf","pdf");
  //c1->Print("M300new_0.57kev.png","png");
  //c1->Print("M300fitnew_0.57kev.pdf","pdf");                                                                           
  //c1->Print("M300fitnew_0.57kev.png","png"); 
}
