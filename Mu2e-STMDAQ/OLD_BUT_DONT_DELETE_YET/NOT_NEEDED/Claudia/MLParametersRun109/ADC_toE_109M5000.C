...
void ADC_toE_109M5000() {
  ...
  //Abrimos el txt
  fstream readfile;
  //readfile.open("../../../DATA/Claudia/MLParametersRun109/M5000L5000/run_00109.txt",ios::in);
  readfile.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M5000L5000/run_00109.txt",ios::in);
  string name;
  ...
  cout<<"Mean L=5000: "<<h1->GetMean()<<endl;
  cout<<"RMS L=5000: "<<h1->GetRMS()<<endl;
  cout<<"MeanError L=5000: "<<h1->GetMeanError()<<endl;
  cout<<"RMSError L=5000: "<<h1->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile2;
  //readfile2.open("../../../DATA/Claudia/MLParametersRun109/M5000L2000/run_00109.txt",ios::in);
  readfile2.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M5000L2000/run_00109.txt",ios::in);
  string name2;
  ...
  cout<<"Mean L=2000: "<<h2->GetMean()<<endl;
  cout<<"RMS L=2000: "<<h2->GetRMS()<<endl;
  cout<<"MeanError L=2000: "<<h2->GetMeanError()<<endl;
  cout<<"RMSError L=2000: "<<h2->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile3;
  //readfile3.open("../../../DATA/Claudia/MLParametersRun109/M5000L1000/run_00109.txt",ios::in);
  readfile3.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M5000L1000/run_00109.txt",ios::in);
  string name3;
  ...
  cout<<"Mean L=1000: "<<h3->GetMean()<<endl;
  cout<<"RMS L=1000: "<<h3->GetRMS()<<endl;
  cout<<"MeanError L=1000: "<<h3->GetMeanError()<<endl;
  cout<<"RMSError L=1000: "<<h3->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile4;
  //readfile4.open("../../../DATA/Claudia/MLParametersRun109/M5000L500/run_00109.txt",ios::in);
  readfile4.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M5000L500/run_00109.txt",ios::in);
  string name4;
  ...
  cout<<"Mean L=500: "<<h4->GetMean()<<endl;
  cout<<"RMS L=500: "<<h4->GetRMS()<<endl;
  cout<<"MeanError L=500: "<<h4->GetMeanError()<<endl;
  cout<<"RMSError L=500: "<<h4->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile5;
  //readfile5.open("../../../DATA/Claudia/MLParametersRun109/M5000L100/run_00109.txt",ios::in);
  readfile5.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M5000L100/run_00109.txt",ios::in);
  string name5;
  ...
  cout<<"Mean L=100: "<<h5->GetMean()<<endl;
  cout<<"RMS L=100: "<<h5->GetRMS()<<endl;
  cout<<"MeanError L=100: "<<h5->GetMeanError()<<endl;
  cout<<"RMSError L=100: "<<h5->GetRMSError()<<endl;



  std::string str = "{}^{137}Cs, M=5000";
...
//line661->Draw("same");
 auto leg1 = new TLegend(0.21,0.5,0.44,0.82);
  ...
  leg1->AddEntry(h5, "L=100","l");                                                                            
  leg1->AddEntry(h4, "L=500","l");
  leg1->AddEntry(h3, "L=1000","l");
  leg1->AddEntry(h2, "L=2000","l");
  leg1->AddEntry(h1, "L=5000","l");
  leg1->Draw("same");



  //c1->Print("M5000_0.57kev.pdf","pdf");
  //c1->Print("M5000_0.57kev.png","png");
  //c1->Print("M5000fit_0.57kev.pdf","pdf");                                                                           
  //c1->Print("M5000fit_0.57kev.png","png"); 
}
