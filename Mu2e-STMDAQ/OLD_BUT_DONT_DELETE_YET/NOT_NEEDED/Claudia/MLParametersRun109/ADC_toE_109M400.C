...
void ADC_toE_109M400() {
  ...
  //Abrimos el txt
  fstream readfile;
  //readfile.open("../../../DATA/Claudia/MLParametersRun109/M400L400/run_00109.txt",ios::in);
  ...
  //Abrimos el txt
  fstream readfile2;
  //readfile2.open("../../../DATA/Claudia/MLParametersRun109/M400L200/run_00109.txt",ios::in);
  ...
  //Abrimos el txt
  fstream readfile3;
  //readfile3.open("../../../DATA/Claudia/MLParametersRun109/M400L100/run_00109.txt",ios::in);
...
//line661->Draw("same");
 ...
 auto leg1 = new TLegend(0.21,0.6,0.55,0.82);
  ...
  //c1->Print("M400new_0.57kev.pdf","pdf");
  //c1->Print("M400new_0.57kev.png","png");
  //c1->Print("M400fitnew_0.57kev.pdf","pdf");                                                                           
  //c1->Print("M400fitnew_0.57kev.png","png"); 
}
