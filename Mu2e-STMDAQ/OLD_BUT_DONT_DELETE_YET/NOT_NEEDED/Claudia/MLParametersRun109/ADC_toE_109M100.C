...
void ADC_toE_109M100() {
  ...
  //Abrimos el txt
  fstream readfile;
  readfile.open("../../../DATA/Claudia/MLParametersRun109/M100L100/run_00109.txt",ios::in);
  string name;
  ...
  cout<<"Mean L=100: "<<h1->GetMean()<<endl;
  cout<<"RMS L=100: "<<h1->GetRMS()<<endl;
  cout<<"MeanError L=100: "<<h1->GetMeanError()<<endl;
  cout<<"RMSError L=100: "<<h1->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile2;
  readfile2.open("../../../DATA/Claudia/MLParametersRun109/M100L50/run_00109.txt",ios::in);
  string name2;
  ...
  cout<<"Mean L=50: "<<h2->GetMean()<<endl;
  cout<<"RMS L=50: "<<h2->GetRMS()<<endl;
  cout<<"MeanError L=50: "<<h2->GetMeanError()<<endl;
  cout<<"RMSError L=50: "<<h2->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile3;
  readfile3.open("../../../DATA/Claudia/MLParametersRun109/M100L20/run_00109.txt",ios::in);
  string name3;
  ...
  cout<<"Mean L=20: "<<h3->GetMean()<<endl;
  cout<<"RMS L=20: "<<h3->GetRMS()<<endl;
  cout<<"MeanError L=20: "<<h3->GetMeanError()<<endl;
  cout<<"RMSError L=20: "<<h3->GetRMSError()<<endl;



  std::string str = "{}^{137}Cs, M=100";
...
//line661->Draw("same");
  ...
  leg1->AddEntry(h3, "L=20","l");
  leg1->AddEntry(h2, "L=50","l");
  leg1->AddEntry(h1, "L=100","l");
  leg1->Draw("same");
