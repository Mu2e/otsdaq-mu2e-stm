...
void ADC_toE_109M600() {
  ...
  //Abrimos el txt
  fstream readfile;
  //readfile.open("../../../DATA/Claudia/MLParametersRun109/M600L600/run_00109.txt",ios::in);
  readfile.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M600L600/run_00109.txt",ios::in);  
  string name;
  ...
  cout<<"Mean L=600: "<<h1->GetMean()<<endl;
  cout<<"RMS L=600: "<<h1->GetRMS()<<endl;
  cout<<"MeanError L=600: "<<h1->GetMeanError()<<endl;
  cout<<"RMSError L=600: "<<h1->GetRMSError()<<endl;
  ...
  fstream readfile2;
  //readfile2.open("../../../DATA/Claudia/MLParametersRun109/M600L300/run_00109.txt",ios::in);
  readfile2.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M600L300/run_00109.txt",ios::in);  
  string name2;
  ...
  cout<<"Mean L=300: "<<h2->GetMean()<<endl;
  cout<<"RMS L=300: "<<h2->GetRMS()<<endl;
  cout<<"MeanError L=300: "<<h2->GetMeanError()<<endl;
  cout<<"RMSError L=300: "<<h2->GetRMSError()<<endl;
  ...
  fstream readfile3;
  //readfile3.open("../../../DATA/Claudia/MLParametersRun109/M600L100/run_00109.txt",ios::in);
  readfile3.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M600L100/run_00109.txt",ios::in);  
  string name3;
  ...
  cout<<"Mean L=100: "<<h3->GetMean()<<endl;
  cout<<"RMS L=100: "<<h3->GetRMS()<<endl;
  cout<<"MeanError L=100: "<<h3->GetMeanError()<<endl;
  cout<<"RMSError L=100: "<<h3->GetRMSError()<<endl;
  ...
  fstream readfile4;
  readfile4.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M600L50/run_00109.txt",ios::in);  
  string name4;
  ...
  cout<<"Mean L=50: "<<h4->GetMean()<<endl;
  cout<<"RMS L=50: "<<h4->GetRMS()<<endl;
  cout<<"MeanError L=50: "<<h4->GetMeanError()<<endl;
  cout<<"RMSError L=50: "<<h4->GetRMSError()<<endl;
...
//line661->Draw("same");
 auto leg1 = new TLegend(0.21,0.6,0.55,0.82);
  ...
  leg1->AddEntry(h4, "L=50","l");
  leg1->AddEntry(h3, "L=100","l");
  leg1->AddEntry(h2, "L=300","l");
  leg1->AddEntry(h1, "L=600","l");
  leg1->Draw("same");



  //c1->Print("M600_0.57kev.pdf","pdf");
  //c1->Print("M600_0.57kev.png","png");
  //c1->Print("M600fit_0.57kev.pdf","pdf");                                                                           
  //c1->Print("M600fit_0.57kev.png","png"); 
}
