...
void ADC_toE_109M15000() {
  ...
  double xx1[2]={640,680};
  double yy1[2]={0,700};
  TGraph *graph1 = new TGraph (2,xx1,yy1);
  graph1->GetXaxis()->SetRangeUser(640,680);      
  graph1->GetYaxis()->SetRangeUser(0,700);
  graph1->SetTitle("{}^{137}Cs, M=15000");
  ...
  double fitrange[2]={650, 675};

  //M15000L15000  
  TH1F*h1 = new TH1F("TH1","", bins, xx1[0], xx1[1]);//binning of 0.57 kev    
  //Abrimos el txt
  fstream readfile;
  //readfile.open("../../../DATA/Claudia/MLParametersRun109/M15000L15000/run_00109.txt",ios::in);
  readfile.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M15000L15000/run_00109.txt",ios::in);  
  string name;
  ...
  Fitwide->SetParameters(5.00221e+02,660,2);
  ...
  cout<<"Mean L=15000: "<<h1->GetMean()<<endl;
  cout<<"RMS L=15000: "<<h1->GetRMS()<<endl;
  cout<<"MeanError L=15000: "<<h1->GetMeanError()<<endl;
  cout<<"RMSError L=15000: "<<h1->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile2;
  //readfile2.open("../../../DATA/Claudia/MLParametersRun109/M15000L10000/run_00109.txt",ios::in);
  readfile2.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M15000L10000/run_00109.txt",ios::in);
  string name2;
  ...
  Fitwide2->SetParameters(1.31429e+02,661,2.01827e+00 );
  ...
  cout<<"Mean L=10000: "<<h2->GetMean()<<endl;
  cout<<"RMS L=10000: "<<h2->GetRMS()<<endl;
  cout<<"MeanError L=10000: "<<h2->GetMeanError()<<endl;
  cout<<"RMSError L=10000: "<<h2->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile3;
  //readfile3.open("../../../DATA/Claudia/MLParametersRun109/M15000L5000/run_00109.txt",ios::in);
  readfile3.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M15000L5000/run_00109.txt",ios::in);
  string name3;
  ...
  Fitwide3->SetParameters(1.31429e+02,665,2.01827e+00 );
  ...
  cout<<"Mean L=5000: "<<h3->GetMean()<<endl;
  cout<<"RMS L=5000: "<<h3->GetRMS()<<endl;
  cout<<"MeanError L=5000: "<<h3->GetMeanError()<<endl;
  cout<<"RMSError L=5000: "<<h3->GetRMSError()<<endl;
  ...
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile4;
  //readfile4.open("../../../DATA/Claudia/MLParametersRun109/M15000L1000/run_00109.txt",ios::in);
  readfile4.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M15000L1000/run_00109.txt",ios::in);
  string name4;
  ...
  cout<<"Mean L=1000: "<<h4->GetMean()<<endl;
  cout<<"RMS L=1000: "<<h4->GetRMS()<<endl;
  cout<<"MeanError L=1000: "<<h4->GetMeanError()<<endl;
  cout<<"RMSError L=1000: "<<h4->GetRMSError()<<endl;
  ...
  //
  //M15000L500                                                                                                                                                                                                                                                
  TH1F*h5 = new TH1F("TH5","", bins, xx1[0], xx1[1]);//binning of 0.57 kev                                                                                                                                                                                           
  //Abrimos el txt                                                                                                                                                                                                                                            
  fstream readfile5;
  //readfile5.open("../../../DATA/Claudia/MLParametersRun109/M15000L500/run_00109.txt",ios::in);
  readfile5.open("/data1/cgarcia/DATA/MWD_Analysis/RUN109/M15000L500/run_00109.txt",ios::in);
  string name5;
  vector<string> file_name5;
  file_name5.clear();
  ...
  while(1){
    readfile5>>name5;
    file_name5.push_back(name5);
    if(readfile5.eof())break;
    //cout<<name<<endl;                                                                                                                                                                                                                                       
  }
  std::cout<<"Size: "<<file_name5.size()<<std::endl;
  for (int file=0;file<(file_name5.size()-1);file++){
    string path;
    path=file_name5[file];
    //cout<<file_name.size()<<endl;                                                                                                                                                                                                                           
    cout<<path.c_str()<<endl;
  ...
  //Fit Energy peak Cessium                                                                                                                                                                                                                                   
  TF1*Fitwide5 = new TF1("Fitwide5", "[0]*TMath::Gaus(x,[1],[2])", xx1[0], xx1[1]);
  Fitwide5->SetParameters(1.31429e+02,665,2.01827e+00 );
  h5->Fit(Fitwide5,"0","",fitrange[0], fitrange[1]);


  Fitwide5->SetLineColor(kOrange);                                      
  Fitwide5->SetLineStyle(2);             
  Fitwide5->Draw("same");                                                                                                                                                                                           


  cout<<"Mean L=500: "<<h5->GetMean()<<endl;
  cout<<"RMS L=500: "<<h5->GetRMS()<<endl;
  cout<<"MeanError L=500: "<<h5->GetMeanError()<<endl;
  cout<<"RMSError L=500: "<<h5->GetRMSError()<<endl;

  std::string str = "{}^{137}Cs, M=15000";
...
//line661->Draw("same");
 auto leg1 = new TLegend(0.21,0.5,0.44,0.82);
  ...
  leg1->AddEntry(h5, "L=500","l");                                                                            
  leg1->AddEntry(h4, "L=1000","l");
  leg1->AddEntry(h3, "L=5000","l");
  leg1->AddEntry(h2, "L=10000","l");
  leg1->AddEntry(h1, "L=15000","l");
  leg1->Draw("same");



  //c1->Print("M15000_0.57kev.pdf","pdf");
  //c1->Print("M15000_0.57kev.png","png");
  c1->Print("M15000fit_0.57kev.pdf","pdf");                                                                           
  c1->Print("M15000fit_0.57kev.png","png"); 
}
