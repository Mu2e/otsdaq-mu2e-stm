...
void ADC_toE_109M500() {
  ...
  //Abrimos el txt
  fstream readfile;
  //readfile.open("../../../DATA/Claudia/MLParametersRun109/M500L500/run_00109.txt",ios::in);
  ...
  fstream readfile2;
  //readfile2.open("../../../DATA/Claudia/MLParametersRun109/M500L200/run_00109.txt",ios::in);
  ...
  Fitwide2->SetParameters(1.31429e+1,663,2.01827e+00 );
  ...
  fstream readfile3;
  //readfile3.open("../../../DATA/Claudia/MLParametersRun109/M500L100/run_00109.txt",ios::in);
  ...
  Fitwide3->SetParameters(1.31429e+01,663,3);
...
//line661->Draw("same");
 auto leg1 = new TLegend(0.21,0.6,0.55,0.82);
  ...
  //c1->Print("M500new_0.57kev.pdf","pdf");
  //c1->Print("M500new_0.57kev.png","png");
  //c1->Print("M500fitnew_0.57kev.pdf","pdf");                                                                           
  //c1->Print("M500fitnew_0.57kev.png","png"); 
}
