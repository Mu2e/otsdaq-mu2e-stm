...
const long double timesample= 10000; // us
...
// Number of int (source) triggers
const int extTrigNum = 2;

// // Registers
// const int prescale = 1;
const uint16_t ext_ADC_offset = 0; // Clock ticks
// const int ext_slice_length
// const int ext_slice_num
// const int ext_trig_timeout
// const int ext_int_delay
const int int_trig_num = 2;
const uint16_t int_ADC_offset = 0; // clock ticks
