...
void ADC_toE_109() {
  ...
  TH1F*h1 = new TH1F("TH1","", 4848, 0, 800);
  ...
  TF1*Fitwide = new TF1("Fitwide", "[0]*TMath::Gaus(x,[1],[2])", 680, 710);
  Fitwide->SetParameters(1.31429e+02,6.95250e+02,2.01827e+00 );
  h1->Fit(Fitwide,"0","",680, 710);
  ...
  cout<<"RMSError: "<<h1->GetRMSError()<<endl;
   ...
   TLine *line661=new TLine(661.7,0,661.7,200);
  line661->Draw("same");
