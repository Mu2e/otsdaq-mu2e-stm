...
void Spectrum109() {
  ...
  graph1->GetYaxis()->SetRangeUser(0,280);
  graph1->SetTitle("");
  ...
  h1->Draw("same");
   ...
   TF1*Fitwide = new TF1("Fitwide", "[0]*TMath::Gaus(x,[1],[2])", -1150, -1050);
   Fitwide->SetParameters(2.01505e+02,-1.09731e+03,-4.79156e+00);
  
   
   h1->Fit(Fitwide,"0","",-1150, -1050);
  ...
  //  c1->Print("ADCCountsFit_run00109.pdf","pdf");
  // c1->Print("ADCCountsFit_run00109.png","png");
