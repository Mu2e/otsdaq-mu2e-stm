...
int main(int argc, char* av[])
{
	...
	while(1)
	{
		...
		std::string rootname =
		    output_filename + "/" +
		    input_filenamestring.substr(input_filenamestring.find("pulse"), 8) + "_" +
		    clientnumber + "_" + std::to_string(request_nbr) + ".root";
		...
		std::cout << "Bytes read: " << bytesread << " Bytes requested: " << byteschunk
		          << " Bytes received: " << nbytes << std::endl;
