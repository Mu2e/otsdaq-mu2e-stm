...
double ehDriftFunctions::PosCompPhot(std::vector<double> cylpos_init,double energy){
  ...
  if(energy<600){
    ...
    pos_processx=xinit+distribution1(rnd_gen);
    pos_processy=yinit+distribution1(rnd_gen);
    pos_processz=zinit+distribution1(rnd_gen);
  ...
  if((energy>=600)&&(energy<=1000)){
    ...
    pos_processx=xinit+distribution2(rnd_gen);
    pos_processy=yinit+distribution2(rnd_gen);
    pos_processz=zinit+distribution2(rnd_gen);
    /*std::cout<<"New x:"<< pos_processx<<std::endl;
    std::cout<< "New y:"<< pos_processy<<std::endl;
    std::cout<< "New z:"<< pos_processz<<std::endl;*/
  }
  if(energy>1000){
    ...
    pos_processx=xinit+distribution3(rnd_gen);
    pos_processy=yinit+distribution3(rnd_gen);
    pos_processz=zinit+distribution3(rnd_gen);
    /*std::cout<<"New x:"<< pos_processx<<std::endl;
    std::cout<< "New y:"<< pos_processy<<std::endl;
    std::cout<< "New z:"<< pos_processz<<std::endl;*/
  }
