...
int main(int narg, char* arg[])
{
	...
	for(unsigned long int i = 0; i < (n - window); i++)
	{
		...
		if((gradient[i] < threshold) && (peak == false))
		{
			...
			cout << "Trigger number: " << triggercounter << ": " << trigger
			     << " Triggertime: " << trigger * tadc << endl;
			triggercounter++;
	...
	string s =
	    "/work/cgarcia/DATA/Claudia/GenData/MWDEfficiency_SimPoisson/"
	    "SuppresedFiles_tbefore2us_tafter10us/Supdata" +
	    filename.substr(filename.find("Noise"), 15);
