...
*/
	...
	{
		std::cout << "" << endl;
		cout << "Chunk goes from: " << int(nADC_chunk * i) << " to "
		     << int(nADC_chunk * i + (nADC_chunk - 1)) << endl;
		...
		std::cout << "" << endl;
		cout << "Chunk goes from: " << unsigned(nADC_chunk * (i + overlapped_chunk))
		     << " to " << unsigned(nADC_chunk * (i + overlapped_chunk) + (nADC_chunk - 1))
		     << endl;
