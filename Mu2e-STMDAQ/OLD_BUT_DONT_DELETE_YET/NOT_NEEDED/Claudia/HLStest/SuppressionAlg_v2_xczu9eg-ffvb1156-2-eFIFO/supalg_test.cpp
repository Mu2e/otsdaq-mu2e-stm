...
int main () {
  ...
  for(ulongint_data i=0;i<nchunks;i++){
    ...
    ulongint_data lasttrigstored3 = (ulongint_data) alldata[0] << 0    & (ulongint_data) 0x000000000000FFFF;
    ulongint_data lasttrigstored2 = (ulongint_data) alldata[1] << 16 & (ulongint_data) 0x00000000FFFF0000;
    ulongint_data lasttrigstored1 = (ulongint_data) alldata[2] << 32 & (ulongint_data) 0x0000FFFF00000000;
    ulongint_data lasttrigstored0 = (ulongint_data) alldata[3] << 48 & (ulongint_data) 0xFFFF000000000000;
    last_triggerstored = (ulongint_data)(lasttrigstored0 | lasttrigstored1 | lasttrigstored2 | lasttrigstored3);
