...
def FMC120_clocktree_init(wibNode,clockmode):
   ...
   s.spi_write(wibNode,LMK_SELECT,0x100,0x63) #DIV_CLKOUT1_0 DIV_BY_3 = 1GHz, IDL/ODL == 1  ==> In/Out Drive level = higher
   ...
   s.spi_write(wibNode,LMK_SELECT,0x108,0x66) #DIV_CLKOUT  DIV_CLKOUT1_0 DIV_BY_3 = 1GHz, IDL/ODL == 1  ==> In/Out Drive level = higher
   ...
   s.spi_write(wibNode,LMK_SELECT,0x110,0x63) #DIV_CLKOUT5_4  DIV_BY_3 = 1GHz, IDL/ODL= 1  ==>In/Out Drive level = higher  
   ...
   s.spi_write(wibNode,LMK_SELECT,0x118,0x63) #DIV_CLKOUT7_6     DIV_BY_3 = 1GHz, IDL/ODL= 1  ==>In/Out Drive level 
   ...
   s.spi_write(wibNode,LMK_SELECT,0x120,0x66) #DIV_CLKOUT9_8   	// DIV_BY_3 = 1GHz, IDL/ODL= 1  ==>In/Out Drive level normal  
   ...
   s.spi_write(wibNode,LMK_SELECT,0x128,0x66) #DIV_CLKOUT9_8   	// DIV_BY_3 = 1GHz, IDL/ODL= 1  ==>In/Out Drive level normal  
   ...
   s.spi_write(wibNode,LMK_SELECT,0x13A,0x00) #SYSREF_DIV(MS) SYSREF Divider   
   s.spi_write(wibNode,LMK_SELECT,0x13B,0x60) #SYSREF_DIV(LS) SYSREF Divider              
