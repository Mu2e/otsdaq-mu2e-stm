...
os.system("ping -c 1 -w2 192.168.42.210")
...
hw.getNode("Buffers.Test_beam.ext_ADC_offset").write(0x2)
hw.dispatch()
hw.getNode("Buffers.Test_beam.Start_reset_stop_clock").write(0x1)
hw.dispatch()
hw.getNode("Buffers.Controls_misc.reset_trig_fifos").write(0x1)
hw.dispatch()
hw.getNode("Buffers.Test_beam.Test_beam_10g_readout").write(0x1)
hw.dispatch()
hw.getNode("Buffers.Test_beam.teng_interpacket_pause").write(0x460)
hw.dispatch()
hw.getNode("Buffers.Test_beam.ext_slice_length").write(0x400)
hw.dispatch()
hw.getNode("Buffers.Test_beam.ext_slice_num").write (0x1000) # (0x000a) # 
hw.dispatch()
#time.sleep (0.5)
hw.getNode("Buffers.Test_beam.ext_int_delay").write(0xFDE8)
hw.dispatch()
hw.getNode("Buffers.Test_beam.int_ADC_offset").write(0x2)
hw.dispatch()
hw.getNode("Buffers.Test_beam.int_slice_length").write(0x400)
hw.dispatch()
hw.getNode("Buffers.Test_beam.int_slice_num").write (0x800) # (0x0a) 
hw.dispatch()
hw.getNode("Buffers.Test_beam.ext_trig_timeout").write(0x5285d)
hw.dispatch()
...
while (n > 0):
   ...
   print("Write Address:"), 
   print(hex(temp))
   #if (hex(temp) >= 0x7ffff800):
   #  print ("Break clause 2")
   #  n= -1
   #  break
