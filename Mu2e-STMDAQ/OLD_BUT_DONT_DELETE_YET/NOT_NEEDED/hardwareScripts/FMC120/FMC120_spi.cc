...
// i^2c write
void FMC120_spi::i2c_write(IPBusManager* hw, uint32_t slaveaddr, uint32_t data)
{
	int i2c_busy = 1;
	int rc       = 0;
...
// spi read
uint32_t FMC120_spi::spi_read(IPBusManager* hw, uint32_t spi_select, uint32_t spi_addr)
{
...
// spi write
uint32_t FMC120_spi::spi_write(IPBusManager* hw,
                               uint32_t      spi_select,
                               uint32_t      spi_addr,
                               uint32_t      spi_value)
{
