...
int initADC::init_FMC120(IPBusManager* hw)
{
	...
	if(((temp & 0xF000) >> 12) == 8)
	{
		...
		{
			std::cout << "Temp (AD7291) : OK " << std::fixed << std::setprecision(2)
			          << result << std::endl;
		}
		else
		{
			std::cout << "Temp (AD7291) : ERROR " << std::fixed << std::setprecision(2)
			          << result << std::endl;
		}
	}
	else
	{
		std::cout << "Error reading from monitoring device. Wrong channel number returned"
		          << std::endl;
	}
	...
	if(((temp & 0xF000) >> 12) == 0)
	{
		...
		{
			std::cout << "Vin0 (0.9Va) : OK " << std::fixed << std::setprecision(2)
			          << result << "V" << std::endl;
		}
		else
		{
			std::cout << "Vin0 (0.9Va) : ERROR " << std::fixed << std::setprecision(2)
			          << result << "V" << std::endl;
		}
	}
	else
	...
	if(((temp & 0xF000) >> 12) == 5)
	{
		...
		{
			std::cout << "Vin5 (3.0Va) : OK " << std::fixed << std::setprecision(2)
			          << result << "V" << std::endl;
		}
		else
		{
			std::cout << "Vin5 (3.0Va) : ERROR " << std::fixed << std::setprecision(2)
			          << result << "V" << std::endl;
		}
	}
	else
	...
	if(((temp & 0xF000) >> 12) == 6)
	{
		...
		{
			std::cout << "Vin6 (3.3Va) : OK " << std::fixed << std::setprecision(2)
			          << result << "V" << std::endl;
		}
		else
		{
			std::cout << "Vin6 (3.3Va) : ERROR " << std::fixed << std::setprecision(2)
			          << result << "V" << std::endl;
		}
	}
	else
	...
	if(((temp & 0xF000) >> 12) == 7)
	{
		...
		if(result < (-2.6 * 0.9) && result > (-2.6 * 1.1))
		{
			std::cout << "Vin7 (-2.6Va) : OK " << std::fixed << std::setprecision(2)
			          << result << "V" << std::endl;
		}
		else
		{
			std::cout << "Vin7 (-2.6Va) : ERROR " << std::fixed << std::setprecision(2)
			          << result << "V" << std::endl;
		}
	}
	else
...
int initADC::init_FMC144(IPBusManager* hw)
{
	...
	int16_t* buf =
	    u.GenerateWaveform16(burstlength, 128, pow(2.0, 15.0), u.genSineWave());
