...
def FMC120_clocktree_init(wibNode,clockmode):
   ...
   s.spi_write(wibNode,LMK_SELECT,0x14A,0x00) #Setting the reset pin to input 
   time.sleep(0.01)
   ...
   s.spi_write(wibNode,LMK_SELECT,0x130,0x6A) #DIV_CLKOUT13_12   	// DIV_BY_3 = 1GHz, IDL/ODL= 1  ==>In/Out Drive level normal  
   ...
   s.spi_write(wibNode,LMK_SELECT,0x14A,0x00)  # 0x00 #RESET_MUX RESET Pin=Input   
   ...
   s.spi_write(wibNode,LMK_SELECT,0x172,0x02) #  Erdem changed from 0x171 Feb 24 
