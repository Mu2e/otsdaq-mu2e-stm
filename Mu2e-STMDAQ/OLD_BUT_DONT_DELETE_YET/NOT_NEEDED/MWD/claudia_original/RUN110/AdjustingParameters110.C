...
void AdjustingParameters110() {
  ...
  std::ifstream myFile("../../../DATA/MWD_Analysis/RUN110/run00110.new.bin_00", ios::in | ios::binary);
 ...
 TLine *linenoiseup=new TLine(0,mean+threesigmas,10000000,mean+threesigmas);                                                                                  
   linenoiseup->Draw("same");                                                                                                                                
                                                                                                                                                                       
   TLine *linenoisedown=new TLine(0,mean-threesigmas,10000000,mean-threesigmas);                                                                                
   linenoisedown->Draw("same");                                                                                                                              
                                                                                                                                                                       
     TLine *linemean=new TLine(0,mean,10000000,mean);                                                                                                 
     linemean->Draw("same");                                                                                                                                
