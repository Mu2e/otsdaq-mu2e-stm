...
void write_data()
{
	...
	while(!exitFE)
	{
		...
		cout << "Writing trigger number " << writeArray.trigNum
		     << ". Dropped packets = " << writeArray.droppedPackets
		     << ". Data written = " << totalDataSize * 1e-6 << " Mb" << endl;
...
void monitor_thread(int run_number)
{
	...
	cout << "Run number: " << run_number
	     << ". Data dir: " << xml_file->value("stm.raw_binary_filename")
	     << ". Started: " << ctime(&runStart);
	...
	while(!exitFE)
	{
		...
		cout << "Time elapsed: " << day_str << ":" << hour_str << ":" << minutes_str
		     << ":" << seconds_str << ". Trigger number: " << readArray.trigNum
		     << ". Dropped packets = " << readArray.droppedPackets
		     << ". Data written = " << totalDataSize * 1e-6 << " Mb\r";
		// cout << "------------------------------------- " << endl;
		// cout << "--> Press Ctrl+C ONCE to safely exit... " << endl;
		// cout << "------------------------------------- " << endl;
		fflush(stdout);
