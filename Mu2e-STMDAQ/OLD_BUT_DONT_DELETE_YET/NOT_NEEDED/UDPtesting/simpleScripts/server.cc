...
int main()
{
	...
	int bufferSize =
	    setsockopt(socket, SOL_SOCKET, SO_RCVBUF, (char*)&rcvbufsize, sizeof(rcvbufsize));
...
>>>>>>> bde1220c1687242e5c4d658ec8637a27ae90fbe5
	...
	cout << "\nReceived " << packetCount << "/" << packetNum << " expected packets"
	     << " = " << double(packetCount) / double(packetNum) * 100 << " % \n"
	     << endl;
