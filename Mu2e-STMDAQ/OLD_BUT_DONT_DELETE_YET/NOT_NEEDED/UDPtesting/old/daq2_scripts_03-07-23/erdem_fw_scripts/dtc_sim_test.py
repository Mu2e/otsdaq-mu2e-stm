...
hw.getNode("Buffers.Readout_regs.ext_trig_timeout").write(0x3A98) # timeout is 75 MHz clock, 200 us = 0x3A98
hw.dispatch()
...
hw.getNode("Buffers.dtc_sim_params.deltahb").write(0x30D4) #(0x190) #(0x240) # #(0x160) #(0x200) In 8 ns intervals, 100us = 0x30D4
hw.dispatch()
hw.getNode("Buffers.dtc_sim_params.numberhb").write(0x3E8) #(0x12F000)  #(0x1000) # #(0x120) #(0xf0) #(0xc0) #(0x60) #(0x30) 
hw.dispatch()
time.sleep(0.02)
