...
const char* SHARED_QUEUE_NAME  =  "MyQueue";

template <class T> class shm_queue {
...
public:
  ...
  shm_queue(allocator_type alloc) : sQueue(alloc) {
...
typedef shm_queue<dataVars::on_event> shm_event_queue;
typedef shm_queue<uint16_t> priority_queue;
typedef shm_queue<dataVars::on_event> on_spill_queue;
typedef shm_queue<dataVars::off_event> off_spill_queue;
typedef shm_queue<dataVars::ps_hdr_event> ps_hdr_queue;
