...
int16_t* ehDriftFunctions::gen_pulse(double Energy, unsigned long int pulseStart,
...
void ehDriftFunctions::init_sim(expConfig exp, std::string rate_stringkHz, double Energy, double timeSample){
  ...
  if (output) std::cout << "Number of pulses generated (real number of simulated pulses at the end of the file): " << pulseNum << std::endl;
