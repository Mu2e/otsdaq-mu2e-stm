...
double ehDriftFunctions::PosCompPhot(std::vector<double> cylpos_init,double energy, std::default_random_engine gen){
  ...
  if(energy<600){
    ...
    std::cout<<"New x:"<< pos_processx<<" "<<distribution1(gen)<<std::endl;
    std::cout<< "New y:"<< pos_processy<<" "<<distribution1(gen)<<std::endl;
    std::cout<< "New z:"<< pos_processz<<" "<<distribution1(gen)<<std::endl;
  }
