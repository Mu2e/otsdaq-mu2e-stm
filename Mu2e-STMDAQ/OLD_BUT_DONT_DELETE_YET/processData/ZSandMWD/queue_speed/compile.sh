...
echo "g++ -std=c++11 -pthread $CCOPTS $WARNING dataVars.cc queue_zs.cc genData.cc testZSdaq.cc -o run.exe"
g++ -pthread $CCOPTS $WARNING dataVars.cc queue_zs.cc genData.cc testDAQ.cc -o run.exe
