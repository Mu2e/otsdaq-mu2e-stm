...
void daqZS::pulse_thread(int chan, queue_zs<int16_t> &pullq, queue_zs<int16_t> &pushq, bool *timeout){
...
void daqZS::suppress_thread(int chan, queue_zs<int16_t> &pullq, queue_zs<int16_t> &pushq, bool *timeout){
