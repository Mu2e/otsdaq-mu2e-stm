...
# Disable standard python flask logging
...
def start_daq():
    ...
    # If not already running...
        ...
        #command = 'screen -dmS ' + stmdaq_screen + ' bash -c "cd $STMDAQ_ROOT; source setup.sh; ./build/bin/testUDP.exe >> ' + fname + '"'      
        command = 'screen -dmS ' + stmdaq_screen + ' bash -c "cd $STMDAQ_ROOT; source setup.sh; ./build/bin/testUDP.exe | tee -a ' + fname + '"'      
