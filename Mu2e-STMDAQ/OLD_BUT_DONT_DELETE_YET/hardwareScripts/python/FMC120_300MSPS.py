...
import FMC120_adc_test_pattern as fb
...
def FMC120_init_noDAC(wibNode,clockmode,tp):
   ...
   while (i <=10):
      ...
      if (tp==0):
        ...
        fb.FMC120_adc_init_tp(wibNode)
        time.sleep(40)
        print("Normal mode enabling")   
        ...
        s.spi_write(wibNode,ADC_SELECT_BOTH,0x6000,0x80) #set control K  - Erdem test mode enabled bit 4
        s.spi_write(wibNode,ADC_SELECT_BOTH,0x6002,0x00) #setting the test pattern
...
def check_adc(wibNode,clockmode,tp):
