...
def initADC(hw_dir):
   ...
   if (success):
      print("ADC initialised succesfully")
      return 1
   else:
      print("ADC initialised failed")
      return 0

def check_adc_status(hw_dir):

   print("Checking ADC status...")
   ...
   if ((temp&0xF000)>>12 == 0):
      result = (temp&0xFFF) * 2.5 / 4096
      if (result  < (0.9*0.9) or result > (0.9*1.1)):
         success = False
   else:
      print("Error reading from monitoring device. Wrong channel number returned")
      success = False
   ...
   if ((temp&0xF000)>>12 == 1):
      result = (temp&0xFFF) * 2.5 / 4096
      if (result  < (1.15*0.9) or result > (1.15*1.1)):
         success = False
   else:
      print("Error reading from monitoring device. Wrong channel number returned")
      success = False
   ...
   if ((temp&0xF000)>>12 == 2):
      result = (temp&0xFFF) * 2.5 / 4096
      if (result  < (1.8*0.9) or result > (1.8*1.1)):
         success = False
   else:
      print("Error reading from monitoring device. Wrong channel number returned")
      success = False
   ...
   if ((temp&0xF000)>>12 == 3):
      result = (temp&0xFFF) * 2.5 / 4096
      if (result  < (1.9*0.9) or result > (1.9*1.1)):
         success = False
   else:
      print("Error reading from monitoring device. Wrong channel number returned")
      success = False
   ...
   if ((temp&0xF000)>>12 == 4):
      result = (temp&0xFFF) * 5.0 / 4096
      if (result  < (2.6*0.9) or result > (2.6*1.1)):
         success = False
   else:
      print("Error reading from monitoring device. Wrong channel number returned")
      success = False
   ...
   if ((temp&0xF000)>>12 == 5):
      result = (temp&0xFFF) * 5.0 / 4096
      if (result < (3.0*0.9) or result > (3.0*1.1)):
         success = False
   else:
      print("Error reading from monitoring device. Wrong channel number returned")
      success = False
   ...
   if ((temp&0xF000)>>12 == 6):
      result = (temp&0xFFF) * 5.0 / 4096
      if (result < (3.3*0.9) or result > (3.3*1.1)):
         success = False
   else:
      print("Error reading from monitoring device. Wrong channel number returned")
      success = False
   ...
   if tp_on == "tp":
      success = f.check_adc(hw,CLOCKTREE_CLKSRC_INTERNAL,1)	
   else:
      success = f.check_adc(hw,CLOCKTREE_CLKSRC_INTERNAL,0)
