...
class MWD {
 ...
 public:
  ...
  std::pair<double, double> calculate_baseline(const std::vector<int16_t>&samples);
 ...
 private:
  ...
  // Parameter to offset basline to close to int16 max value
  double nsigma_baseline_offset; // No of baseline sigmas from int16 max
  double baseline_offset;
  static constexpr double INT16_T_MAX = 32767;
