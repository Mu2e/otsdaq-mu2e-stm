                                                 ...
                                                 std::vector<std::string>& out_files)
{
	...
	// Log to user
	std::cout << "Found " << out_files.size() << " subrun files in directory."
	          << std::endl;
}
...
size_t MultiFileHandler::file_count() const { return filenames_.size(); }

// Get the total number of samples
size_t MultiFileHandler::total_samples() const { return total_samples_; }

// Get the number of read samples
size_t MultiFileHandler::total_samples_read() const { return samples_read_; }
