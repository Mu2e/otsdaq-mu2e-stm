...
uint64_t STMdata::get_event_number(std::vector<int16_t>& data, uint64_t hdr_start_loc)
{
...
uint64_t STMdata::get_EWT(std::vector<int16_t>& data, uint64_t hdr_start_loc)
{
	// Get the trigger/event number
...
// Get the event mode
uint64_t STMdata::get_event_mode(std::vector<int16_t>& data, uint64_t hdr_index)
{
	// Get event mode data
