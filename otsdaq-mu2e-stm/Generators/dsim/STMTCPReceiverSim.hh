...
#include "tcp_utils_sim.hh"   // General utils ( e.g. variable definitions )
...
namespace mu2e {
  ...
  private:
    ...
    // Event counter for fully parsed events
    ...
    static inline uint32_t build_len_from_2_words(uint16_t lo, uint16_t hi)
    {
                                 ...
                                 FragmentType type = FragmentType::STM)
    {
      ...
      // Allocate fragment
      //auto frag = artdaq::FragmentPtr(new artdaq::Fragment(n_bytes, type));
